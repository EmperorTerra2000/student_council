    ...
    <footer className="footer">
      ...
      <div className="footer__content page__spacing">
        ...
        <div className="footer__icons">
          <a className="footer__link-icon" href="#"><img src={iconVk} alt="Вконтакте" className="footer__icon" /></a>
          <a className="footer__link-icon" href="#"><img src={iconInst} alt="Инстаграм" className="footer__icon" /></a>
        </div>
      </div>
    </footer>
  );
